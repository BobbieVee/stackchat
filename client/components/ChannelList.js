...
export default class ChannelList extends Component {
  ...
  render () {
    const channelTotals = this.state.messages.reduce((memo, message) => {
      const channel = message.channelId;
      memo[channel] = memo[channel] ? memo[channel]+1 : 1;
      return memo;
    }, [])
    return (
      <ul>
